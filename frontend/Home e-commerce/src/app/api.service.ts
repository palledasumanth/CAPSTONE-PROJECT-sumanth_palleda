...
BASEURL:string="http://localhost:8081/api/";
  ...
  uploadcsv(data:any){
    return this.http.post("http://localhost:8081/csv/upload",data,{  responseType: 'text'});
  }

  uploadfile(data:any){
    // const headers = new HttpHeaders().set('Content-Type', 'text/plain; charset=utf-8');
    
    return this.http.post("http://localhost:8081/singleFileupload",data,{  responseType: 'text'});
  }
